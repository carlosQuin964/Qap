...
require( ["js/qlik"], function ( qlik ) {
	...
	var app = qlik.openApp('e1968a3d-1597-4c20-bc93-32014b917580', config);


	//get objects -- inserted here --
	app.getObject('QV01','qwpJw');
	app.getObject('QV02','XJMgp');
	app.getObject('QV03','PpmvY');
	app.getObject('QV04','JvDPdJJ');
	app.getObject('QV05','FDmsck');
	app.getObject('QV06','PherPgJ');

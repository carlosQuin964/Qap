...
require( ["js/qlik"], function ( qlik ) {
	...
	var app = qlik.openApp('1b903f4c-6f7b-4238-94ce-e8a1bcf9070b', config);


	//get objects -- inserted here --
	
	
	app.getObject('QV01','tmkEuw');
	app.getObject('QV02','AtJTmYD');
	app.getObject('QV03','qwpJw');
	app.getObject('QV04','XJMgp');
	app.getObject('QV05','jgBhxUT');
	app.getObject('QV06','vGQsYrS');
